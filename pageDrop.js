...
var ERROR_THRESHOLD = 25; //in percentage
  ...
  request({
    ...
    if (!error && response.statusCode == 200) {
      ...
      if(!isAlertsPeriodSilent()){
        checkIfPageDropBreached(resultSet);
      }
    }
  })
}

function checkIfPageDropBreached(resultSet){
...
function triggerAlert(log_message){
  ...
  //})
  var subject = '1JL Page Drops Limit Breached: Raise P3 Inc [Callout:JLWEBSUPP]';
