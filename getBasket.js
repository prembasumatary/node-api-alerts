...
function runHealthCheck(){
    ...
    var duration = 600;
    var queryString = "names[]=Custom/onejl.api.BasketApi%23getBasket().500/Count&names[]=Custom/onejl.api.BasketApi%23getBasket().502/Count"+
    "&names[]=Custom/onejl.api.BasketApi%23getBasket().503/Count&names[]=Custom/onejl.api.BasketApi%23getBasket().504/Count"+
...
function checkIfErrorCountIsOk(response_object){
    ...
    metric_data.metrics.forEach(function(metric){
        ...
        metric.timeslices.forEach(function(slice){
            ...
            var log_message = "The alert condition of Basket Api Errors Limit breached was triggered -<br/><br/>";
...
function triggerAlert(log_message){
  ...
  //})
  var subject = '1JL GetBasket API Error Limit Breached: Raise P3 Inc [Callout:JLWEBSUPP]';
